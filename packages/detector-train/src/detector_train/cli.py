...
def main() -> None:
    ...
    config = TrainConfig(
        ...
        dino_to_yolo_taps={int(k): int(v) for k, v in dict(tc.get("dino_to_yolo_taps", {9: 15, 15: 19, 19: 9})).items()},
        ...
        dino_feat_layer_weights={int(k): float(v) for k, v in dict(tc.get("dino_feat_layer_weights", {9: 0.25, 15: 0.35, 19: 0.40})).items()},
        dino_attn_enabled=bool(tc.get("dino_attn_enabled", True)),
        dino_attn_layers=tuple(int(v) for v in tc.get("dino_attn_layers", [19])),
        dino_attn_weight_stage_a=float(tc.get("dino_attn_weight_stage_a", 0.01)),
        dino_attn_weight_stage_b=float(tc.get("dino_attn_weight_stage_b", 0.005)),
        dino_objmap_enabled=bool(tc.get("dino_objmap_enabled", True)),
        dino_objmap_layer=int(tc.get("dino_objmap_layer", 19)),
        dino_objmap_weight_stage_a=float(tc.get("dino_objmap_weight_stage_a", 0.00)),
        dino_objmap_weight_stage_b=float(tc.get("dino_objmap_weight_stage_b", 0.02)),
        dino_objmap_apply_inside_gt_only=bool(tc.get("dino_objmap_apply_inside_gt_only", False)),
