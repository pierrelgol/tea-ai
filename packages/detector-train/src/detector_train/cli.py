...
def main() -> None:
    ...
    config = TrainConfig(
        ...
        dino_feat_layer_weights={int(k): float(v) for k, v in dict(tc.get("dino_feat_layer_weights", {9: 0.15, 15: 0.45, 19: 0.40})).items()},
        dino_attn_enabled=bool(tc.get("dino_attn_enabled", True)),
        dino_attn_layers=tuple(int(v) for v in tc.get("dino_attn_layers", [19])),
        dino_attn_weight_stage_a=float(tc.get("dino_attn_weight_stage_a", 0.005)),
        dino_attn_weight_stage_b=float(tc.get("dino_attn_weight_stage_b", 0.003)),
        ...
        dino_objmap_apply_inside_gt_only=bool(tc.get("dino_objmap_apply_inside_gt_only", True)),
