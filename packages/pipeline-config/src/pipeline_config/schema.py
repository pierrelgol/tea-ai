...
def load_pipeline_config(path: Path | str = "config.json") -> PipelineConfig:
    ...
    _expect_keys(train, {
        ...
        "dino_to_yolo_taps", "dino_feat_layer_weights",
        "dino_distill_object_weight", "dino_distill_background_weight",
        "dino_attn_enabled", "dino_attn_layers", "dino_attn_weight_stage_a", "dino_attn_weight_stage_b",
        "dino_objmap_enabled", "dino_objmap_layer", "dino_objmap_weight_stage_a", "dino_objmap_weight_stage_b",
        "dino_objmap_apply_inside_gt_only",
